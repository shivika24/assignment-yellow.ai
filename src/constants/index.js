const constants = {
  ...
  AWARD3_DESCRIPTION:
    "The engine doesn’t just index unstructured textual data, but also images with our proprietary optical character recognition (OCR). Get all relevant results, from multiple formats within seconds.",
